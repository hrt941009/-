...
{
    nextPage = nextPage + 1;
//    [CommissionModel getHomePageDataWithTime:_pageRequestTime
//                                         key:_catagoryKey
//                                           p:[NSString stringWithFormat:@"%d", nextPage]
//                                        pnum:kLovPageNumber];
...
//    [searchButton addTarget:self action:@selector(rightDrawerButtonPress:) forControlEvents:UIControlEventTouchUpInside];
//    
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    //------
//    if (isSubject) {
//        _headerLineView.alpha =0;
//    }else{
//        _headerLineView.alpha = 1;
//    }
    [_collectionView reloadData];
}
...
//    subViewController.thumbPath = thumPath;
