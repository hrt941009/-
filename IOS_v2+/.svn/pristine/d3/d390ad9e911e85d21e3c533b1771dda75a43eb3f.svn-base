...
- (id)initWithDelegate:(id)delegate {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"icon_checkBox1.png"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"icon_checkBox2.png"] forState:UIControlStateSelected];
